...
function Provider(props) {
  return /* @__PURE__ */ jsx2(ChakraProvider, { value: system, children: /* @__PURE__ */ jsx2(ColorModeProvider, { ...props }) });
}
...
var CloseButton = React2.forwardRef(function CloseButton2(props, ref) {
  return /* @__PURE__ */ jsx3(ChakraIconButton, { variant: "ghost", "aria-label": "Close", ref, ...props, children: props.children ?? /* @__PURE__ */ jsx3(LuX, {}) });
});
...
var DrawerContent = React3.forwardRef(function DrawerContent2(props, ref) {
  ...
  return /* @__PURE__ */ jsx4(Portal, { disabled: !portalled, container: portalRef, children: /* @__PURE__ */ jsx4(ChakraDrawer.Positioner, { padding: offset, children: /* @__PURE__ */ jsx4(ChakraDrawer.Content, { ref, ...rest, asChild: false, children }) }) });
});
var DrawerCloseTrigger = React3.forwardRef(function DrawerCloseTrigger2(props, ref) {
  return /* @__PURE__ */ jsx4(
    ChakraDrawer.CloseTrigger,
    {
      ...
      ...props,
      asChild: true,
      children: /* @__PURE__ */ jsx4(CloseButton, { size: "sm", ref })
    }
  );
});
...
var ClipboardIcon = React4.forwardRef(function ClipboardIcon2(props, ref) {
  return /* @__PURE__ */ jsx6(ChakraClipboard.Indicator, { copied: /* @__PURE__ */ jsx6(LuCheck, {}), ...props, ref, children: /* @__PURE__ */ jsx6(LuClipboard, {}) });
});
var ClipboardCopyText = React4.forwardRef(function ClipboardCopyText2(props, ref) {
  return /* @__PURE__ */ jsx6(ChakraClipboard.Indicator, { copied: "Copied", ...props, ref, children: "Copy" });
});
...
var ClipboardButton = React4.forwardRef(
  function ClipboardButton2(props, ref) {
    return /* @__PURE__ */ jsx6(ChakraClipboard.Trigger, { asChild: true, children: /* @__PURE__ */ jsxs(Button, { ref, size: "sm", variant: "surface", ...props, children: [
      /* @__PURE__ */ jsx6(ClipboardIcon, {}),
      /* @__PURE__ */ jsx6(ClipboardCopyText, {})
    ] }) });
  }
);
var ClipboardLink = React4.forwardRef(
  function ClipboardLink2(props, ref) {
    return /* @__PURE__ */ jsx6(ChakraClipboard.Trigger, { asChild: true, children: /* @__PURE__ */ jsxs(
      Button,
      {
        unstyled: true,
        variant: "plain",
...
var ClipboardIconButton = React4.forwardRef(function ClipboardIconButton2(props, ref) {
  return /* @__PURE__ */ jsx6(ChakraClipboard.Trigger, { asChild: true, children: /* @__PURE__ */ jsxs(IconButton2, { ref, size: "xs", variant: "subtle", ...props, children: [
    /* @__PURE__ */ jsx6(ClipboardIcon, {}),
    /* @__PURE__ */ jsx6(ClipboardCopyText, { srOnly: true })
  ] }) });
});
var ClipboardInput = React4.forwardRef(
  function ClipboardInputElement(props, ref) {
    return /* @__PURE__ */ jsx6(ChakraClipboard.Input, { asChild: true, children: /* @__PURE__ */ jsx6(Input, { ref, ...props }) });
  }
);
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsxs2(
      Flex,
      {
        ...
        ...rest,
        children: [
          /* @__PURE__ */ jsx7(Text, { as: "span", fontSize: "12px", children: "Hedera Account:" }),
          /* @__PURE__ */ jsx7(Text, { as: "span", textDecoration: "underline", color: "brand.600", _dark: { color: "brand.400" }, children: hederaAccountId }),
          /* @__PURE__ */ jsx7(ClipboardRoot, { value: hederaAccountId, timeout: 1e3, children: /* @__PURE__ */ jsx7(ClipboardIconButton, { bg: "transparent" }) })
        ]
      }
    ),
    /* @__PURE__ */ jsx7(
...
function NavDrawer({
  ...
  return /* @__PURE__ */ jsxs2(DrawerRoot, { open: isOpen, onOpenChange: onClose, placement: "end", children: [
    /* @__PURE__ */ jsx7(DrawerBackdrop, {}),
    /* @__PURE__ */ jsxs2(DrawerContent, { ...styling, children: [
      /* @__PURE__ */ jsx7(DrawerHeader, { className: "drawer-header", pt: "4", children: /* @__PURE__ */ jsx7(HeaderLogo, {}) }),
      /* @__PURE__ */ jsx7(DrawerBody, { p: "2", children: /* @__PURE__ */ jsxs2(Stack, { direction: "column", gap: "1", children: [
        orderedMenuList.map((item, index) => /* @__PURE__ */ jsxs2(React5.Fragment, { children: [
          /* @__PURE__ */ jsx7(MainMenuItem, { handleClose, ...item.menuItemProps, children: /* @__PURE__ */ jsxs2(Flex, { flexDirection: "column", children: [
            /* @__PURE__ */ jsx7(Text, { w: "100%", fontSize: "16px", lineHeight: "1.5rem", marginBottom: "0", fontWeight: "600", children: item.title }),
            /* @__PURE__ */ jsx7(Text, { fontSize: "12px", lineHeight: "1.2rem", fontWeight: "400", children: item.description })
          ] }) }),
          /* @__PURE__ */ jsx7(
            Separator,
            {
        ...
        /* @__PURE__ */ jsx7(AccountNumber, { hederaAccountId })
      ] }) }),
      /* @__PURE__ */ jsx7(
        DrawerCloseTrigger,
        {
...
function DrawerComponent({ props }) {
  return /* @__PURE__ */ jsx8(Provider, { children: /* @__PURE__ */ jsx8(NavDrawer, { ...props }) });
}

// src/components/TopBar/index.tsx
import React6, { useRef, useState } from "react";
import { Box as Box2, Flex as Flex2, IconButton as IconButton3 } from "@chakra-ui/react";
...
var IconHamburger = ({ ...rest }) => {
  return /* @__PURE__ */ jsxs4(chakra2.svg, { width: "29px", height: "29px", viewBox: "0 0 29 29", ...rest, children: [
    /* @__PURE__ */ jsx10(
      "rect",
      {
        y: "14.1421",
...
var MenuButton = React6.forwardRef((props, ref) => {
  return /* @__PURE__ */ jsx11(
    IconButton3,
    {
      ...
      ...props,
      ref,
      children: /* @__PURE__ */ jsx11(IconHamburger_default, { fontSize: "2xl", stroke: "black" })
    }
  );
});
var menuListConfig = [
...
function TopBar({ menuList, HeaderLogo, onClose, hederaAccountId }) {
  const NavBarHeaderLogo = HeaderLogo ? HeaderLogo : () => /* @__PURE__ */ jsx11(CaratLogo, { fontSize: "150px", fill: "brand.600", _dark: { fill: "white" } });
  ...
  return /* @__PURE__ */ jsxs5(Fragment2, { children: [
    /* @__PURE__ */ jsxs5(
      Flex2,
      {
        ...
        children: [
          /* @__PURE__ */ jsx11(Link, { className: "navbar-header", to: "/", children: /* @__PURE__ */ jsx11(NavBarHeaderLogo, { className: "navbar-header" }) }),
          /* @__PURE__ */ jsx11(
            MenuButton,
            {
              ref: btnRef,
...
function TopBarComponent(props) {
  return /* @__PURE__ */ jsx11(Provider, { children: /* @__PURE__ */ jsx11(TopBar, { ...props }) });
}
export {
  DrawerComponent as SidebarDrawer,
  TopBarComponent as TopBar,
  system as chakraTheme
};
